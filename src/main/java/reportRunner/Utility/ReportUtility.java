...
public class ReportUtility {
    ...
    public Map<String, LocalDateTime> calculateTimestampsForGatling(String endTime, String duration) {
    ...
    public Map<String, Long> calculateTimestampsV2(TestConfig test) {
        String duration = calculateTestDuration(test.getTestStartTime(), test.getTestEndTime());
        Map<String, LocalDateTime> times = calculateTimestampsForGatling(test.getTestEndTime(), duration);
        return convertToTimestamp(times.get("startTime"), times.get("endTime"));
    }

    public Map<String, Long> calculateTimestamps(TestConfig test) {
        Map<String, LocalDateTime> times = calculateTimestampsForGatling(
                test.getTestEndTime(), test.getStepDuration());
