...
public class MaxPerformanceResultService implements ResultsService {
    ...
    public MaxPerformanceResultService(UtilityConfig utilityConfig, InfluxDBConfig influxDBConfig, VictoriaMetricsConfig victoriaMetricsConfig) {
    ...
    public String createTableForResults(Long len, String path, Test testExemplar) {
        ...
        for (int k = 0; k < testExemplar.getSteps() - 1; k++) {
            ...
            model.fillQueryResults("avgValues",model.getAvgResponseTimeValues());
            model.fillQueryResults("minValues",model.getMinResponseTimeValues());
            model.fillQueryResults("maxValues",model.getMaxResponseTimeValues());
            model.fillQueryResults("stddevValues",model.getStddevResponseTimeValues());
            model.fillQueryResults("cvValues",model.getCvResponseTimeValues());
