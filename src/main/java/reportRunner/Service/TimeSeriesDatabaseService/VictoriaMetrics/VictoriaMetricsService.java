package reportRunner.Service.TimeSeriesDatabaseService.VictoriaMetrics;
...
public class VictoriaMetricsService implements TimeSeriesDatabase {
    ...
    private Map<String,String> avgResponseTimeValues;
    ...
    public VictoriaMetricsService(String startTimestamp, String endTimestamp, VictoriaMetricsConfig victoriaMetricsConfig) {
        ...
        this.avgResponseTimeValues = new HashMap<>();
    ...
    public Map<String,Double> getAvgResponseTimeValues() {
        return convertToDouble(avgResponseTimeValues);
    }
    ...
    public void setQueryResults(String startTimestamp, String endTimestamp) {
        ...
        avgResponseTimeValues.putAll(convertToQueryAndParse(getAvgResponseTimeQuery(duration),startTimestamp,endTimestamp));
        ...
        queryResults.put("avgValues",convertToDouble(avgResponseTimeValues));
    ...
    private String getAvgResponseTimeQuery(String duration) {
        return victoriaMetricsQuery.getAvgResponseTimeQueryVm(duration);
    }
